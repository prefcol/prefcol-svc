// src/Student_Panel/pages/ITCourses.jsx
"use client";
...
export default function ITCourses({ windowWidth, userData = {} }) {
...
useEffect(() => {
  ...
  }, [itCourses, searchTerm, sortBy, filterCategory, filterLevel]);

  const filterAndSortCourses = () => {
    let result = [...itCourses];
  ...
  return (
    <div style={{ padding: "24px 0" }}>
      ...
      <div id="courses-section" style={{ marginBottom: 24 }}>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} sm={12}>
                <Select
                  ...
                  style={{ width: "100%" }}
                >
                  <Option value="all">All IT Subcategories</Option>
                  {[...new Set(itCourses.map(c => c.subcategory))].map(cat => (
        ...
        {/* Course List */}
        <div style={{ backgroundColor: "#fff", padding: 14, borderRadius: 12 }}>
          {filteredCourses.length > 0 ? (
            ...
            <Empty description="No IT courses found" />
          )}
        </div>
      </div>
