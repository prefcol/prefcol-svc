// components/PrivacyPolicyContent.jsx
    ...
    <>
     <div
      style={{
        ...
        padding: '40px 0', // ← Remove left/right padding that can cause layout shift
        boxSizing: 'border-box',
        overflowY: 'auto',  // ✅ Enables vertical scroll
        width: '100vw',     // ✅ Ensure full width
      }}
    >
      {/* Inner container: centered, max-width, no height limit */}
      <div
        style={{
          backgroundColor: '#fff',
          padding: '40px',
          margin: '0 auto', // ← Horizontally center, no vertical centering
          maxWidth: '800px',
          width: '100%',
          borderRadius: '12px',
          boxShadow: '0 4px 12px rgba(0, 0, 0, 0.1)',
          boxSizing: 'border-box',
          // ✅ No maxHeight — let content flow naturally
        }}
      >
        <Title level={2} style={{ color: "#006666" }}>Privacy Policy</Title>
          ...
          <ul>
            ...
            <li><Text strong>Company</Text>: (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Prefcol Edutech Solutions Private Limited.</li>
            ...
            <li><Text strong>Website</Text>: refers to Prefcol Edutech Solutions Private Limited, accessible from https://prefcol.com/</li>
