...
export default function Navigationbar() {
  ...
  const navItems = [
    ...
    { to: "/about-us", label: "About" },
    {
      label: "Courses",
      items: [
        { to: "/it-courses", label: "IT Courses" },
        { to: "/Non_it-courses", label: "Non-IT Courses" },
      ],
    },
    ...
    { to: "/careers", label: "Career" },
    {
      ...
      items: [
        ...
        { to: "/Cancellation_Refund_Policy", label: "Cancellation&Refund Policy" },
        { to: "/Shipping_Delivery_Policy", label: "Shipping&Delivery Policy" },
      ],
    },
  ];
                        ...
                        <div className="py-1">
                          {item.items.map((subItem) => (
                            <Link
                              key={subItem.to}
                              to={subItem.to}
                              className={`block px-6 py-2 text-sm text-gray-700 hover:bg-gray-200 hover:text-teal-900 transition-colors duration-300 ${
